...
const BottomLead = ({actionText, description, mainActionText, extraActionText}) => {
  return (
    <div animateOnce="false" style={{textShadow:'0px 1px 1px gray'}} 
     className="p-5 lg:bg-bottom lg:bg-cover lg:bg-center lg:bg-fixed bg-gray-100 text-white 
      ...
      <div className="text-3xl lg:text-4xl pt-2 lg:font-bold font-semibold text-colorOne lg:text-colorTwo lg:text-white">{actionText}
      </div>
      <div className="text-lg lg:text-2xl pt-4 text-gray-500 lg:text-gray-200">{description}
      </div>
      <div className="py-5 lg:py-8 flex flex-col lg:flex-row items-center justify-center min-h-48">
